				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-xs-12 col-sm-8 col-md-6"> <!-- div para diminuir o tamanho dos inputs do form -->
							...
							echo form_open('categorias/create', 'class="form-horizontal"');
							echo validation_errors('<div class="alert alert-warning" role="alert">', '</div>');
							echo form_label('Descrição');
							echo form_input(array('name' => 'descricaocategoria','placeholder'=>'Descrição (até 15 caracteres)', 'class' => 'form-control'), set_value('descricaocategoria'), 'autofocus');
