					...
					<div class="panel-body">
						<div class="col-xs-12 col-sm-8 col-md-6"> <!-- div para diminuir o tamanho dos inputs do form -->
							<div class="btn-group btn-group-sm" role="group" aria-label="basic-options">
								...
								echo form_open("cursos/delete/$iduser");
								echo form_label('Descrição');
								echo form_input(array('name'=>'descricaocurso', 'class' => 'form-control'),set_value('Descricao',$query->descricaocurso),'disabled="disabled"');
