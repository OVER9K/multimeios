		...
		<div class="row">
			<div id="conteudo" class="col-xs-12 col-sm-8 col-md-9">
				...
				<div class="panel panel-default">
					...
					?>
					<div class="panel-heading"><h4>Lista de cursos:</h4></div>
					...
					$this->table->set_template($template);
						...
						foreach ($query as $linha):
							$this->table->add_row(
								...
								anchor("cursos/update/$linha->idcurso",'<span class="glyphicon glyphicon-pencil"></span>').
								' - '.anchor("cursos/delete/$linha->idcurso",'<span class="glyphicon glyphicon-remove"></span>')
								);
						endforeach;
