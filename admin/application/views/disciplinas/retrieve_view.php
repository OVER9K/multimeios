		...
		<div class="row">
			<div id="conteudo" class="col-xs-12 col-sm-8 col-md-9">
				...
				<div class="panel panel-default">
					...
					?>
					<div class="panel-heading"><h4>Lista de disciplinas:</h4></div>
					...
					$this->table->set_template($template);
						...
						$this->table->set_heading('#', 'Descrição','Carga horária','Professor','Curso','Operações');
						foreach ($query as $linha):
							$this->table->add_row(
								$linha->iddisciplina,
								$linha->descricaodisciplina,
								$linha->cargahoraria,
								$linha->nome,
								$linha->descricaocurso,
								anchor("disciplinas/update/$linha->iddisciplina",'<span class="glyphicon glyphicon-pencil"></span>').
								' - '.anchor("disciplinas/delete/$linha->iddisciplina",'<span class="glyphicon glyphicon-remove"></span>')
								);
						endforeach;
