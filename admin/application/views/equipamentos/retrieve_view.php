			...
			<div id="conteudo" class="col-xs-12 col-sm-8 col-md-9">
				...
				<div class="panel panel-default">
					...
					$this->table->set_template($template);
						...
						$this->table->set_heading('#', 'Descrição','Data da Compra','Modelo','Categoria','Operações');
						foreach ($query as $linha):
							$this->table->add_row(
								$linha->idequipamento,
								$linha->descricaoequipamento,
								$linha->datacompra,
								$linha->modelo,
								$linha->descricaocategoria,
								anchor("equipamentos/update/$linha->idequipamento",'<span class="glyphicon glyphicon-pencil"></span>').
								' - '.anchor("equipamentos/delete/$linha->idequipamento",'<span class="glyphicon glyphicon-remove"></span>')
								);
						endforeach;
