		...
		<div class="row">
			<div id="conteudo" class="col-xs-12 col-sm-8 col-md-9">
				...
				<div class="panel panel-default">
					...
					?>
					<div class="panel-heading"><h4>Lista de salas:</h4></div>
					...
					$this->table->set_template($template);
						...
						$this->table->set_heading('#', 'Descrição', 'Bloco','Operações');
						foreach ($query as $linha):
							$this->table->add_row(
								$linha->idsala,
								$linha->descricaosala,
								$linha->bloco,
								anchor("salas/update/$linha->idsala",'<span class="glyphicon glyphicon-pencil"></span>').
								' - '.anchor("salas/delete/$linha->idsala",'<span class="glyphicon glyphicon-remove"></span>')
								);
						endforeach;
