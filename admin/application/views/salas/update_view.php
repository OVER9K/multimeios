					...
					<div class="panel-body">
						<div class="col-xs-12 col-sm-8 col-md-6"> <!-- div para diminuir o tamanho dos inputs do form -->
							<div class="btn-group btn-group-sm" role="group" aria-label="basic-options">
								...
								echo form_open("salas/update/$iduser",'class="form-horizontal"');
								echo validation_errors('<div class="alert alert-warning" role="alert">', '</div>');
								echo form_label('Descrição');
								echo form_input(array('name' => 'descricaosala', 'class' => 'form-control'), set_value('Descrição', $query -> descricaosala), 'autofocus');
								echo form_label('Bloco');
								echo form_input(array('name' => 'bloco', 'class' => 'form-control'), set_value('Bloco', $query -> bloco));
