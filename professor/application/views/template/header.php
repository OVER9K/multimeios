...
<html lang="pt-br">
	<head>
		...
		<meta name="author" content="João OVER9K">
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo base_url(); ?>">
					<img alt="multimeios" src="<?php echo base_url("public/template2/img/favicon-16.png"); ?>"/>
				</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav"> <!-- menu administrativo -->
					...
					<li><?php echo anchor('reservas','Reserva'); ?></li>
					<?php
